...
// A classic scrollbar paints over the page's right edge; the hero headline and the phone pillar words keep
// clear of it (--gutter on the root element; living-system.css, home.css).
new ResizeObserver(()=>document.documentElement.style.setProperty('--gutter',Math.max(0,innerWidth-document.documentElement.clientWidth)+'px')).observe(document.documentElement);
